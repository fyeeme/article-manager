...
<div id="page">
    <div id="content">
        <div class="post">
            <h1 class="title"><?php echo $data['title']; ?>
                <span style="clor:#ccc;font-size: 14px;">作者： <?php echo $data['author']; ?></span>  <span style="clor:#ccc;font-size: 14px;">日期： <?php echo $data['dateline']; ?></span>
            </h1>
